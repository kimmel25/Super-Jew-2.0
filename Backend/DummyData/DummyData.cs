...
public static class DummyData
{
    public static Shul[] GetAllAvailableShuls()
    {
        ...
        var shul1 = new Shul
        {
            ...
            ContactInfo = "Gabai: Yechezkel Dinkinpinky, 201-345-2920",
        ...
        var shul2 = new Shul
        {
            ...
            Denomination = "Orthodox",
            ContactInfo = "Gabai: Belongi Shwartzenstein, 201-238-1230",
        ...
        var shul3 = new Shul
        {
            ...
            Denomination = "Orthodox",
            ContactInfo = "Gabai: Takkapaka Shpinnigger, 201-892-1497",
        ...
        var shul4 = new Shul
        {
            ...
            Denomination = "Orthodox",
            ContactInfo = "Gabai: Yeerbankoop Tribalinko, 917-111-7821",
